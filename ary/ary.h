...
// wartosc jest reprezentowana jako dwie liczby, w wyniku operacji możliwe reprezentacje liczby to [a, b] albo R - [a, b], stąd gdy left <= right zapis oznacza [left, right]
// w przeciwnym wypadku zapis oznacza sume przedziałów (-inf, right] U [left, inf)
